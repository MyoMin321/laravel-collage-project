<x-layout>
    <x-slot name="title">About Our University</x-slot>
    <!--END HEADER SECTION-->
                        ...
                        <div class="ed-advan">
                            <ul>
                                <li>
                                    ...
                                    <div class="ed-ad-dec">
                                        ...
                                        <p>Class aptent taciti sociosqu ad litora torquent per conubia nostra, per
                                            inceptos himenaeos. Morbi bibendum imperdiet bibendum.</p>
                                        <a href="/awards">Read more</a>
                                    </div>
                                </li>
                                <li>
                                    <div class="ed-ad-img">
                                ...
                                <li>
                                    ...
                                    <div class="ed-ad-dec">
                                        <h4>Educations</h4>
                                        <p>Maecenas venenatis, turpis ac tincidunt convallis, leo enim ultrices tortor,
                                            at faucibus neque sapien ac elit. Curabitur ut ipsum odio.</p>
