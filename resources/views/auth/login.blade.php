		...
		<div class="ad-log-main">
			<div class="ad-log-in">
				<div class="ad-log-in-logo">
					<a href="/"><img src="images/PIU-logo.png" alt="" width="250"></a>
				</div>
              ...
              @csrf
                <div>
                    <div class="input-field s12">
                        <input type="text" name="email" data-ng-model="name" class="validate">
            ...
            <div class="input-field s12"> 
              <a href="admin-forgot.html">Forgot password</a> | <a href="#">Create a new account</a> 
            </div>
          </form>
          </div>
				</div>
