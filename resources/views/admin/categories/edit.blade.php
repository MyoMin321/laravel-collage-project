                ...
                <div class="sb2-2-3">
                    <div class="row">
						...
						<div class="box-inn-sp admin-form">
                                <div class="inn-title">
                                    <h4>Add New University's Program Informations</h4>
                                    <p>Here you can edit your website basic details URL, Phone, Email, Address, User and password and more</p>
                                </div>
                                <div class="tab-inn">
                                    <form action="/admin/categories/{{ $category->name }}/update" method="POST">
                                      @method('patch')  
                                      @csrf
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input type="text" name="name" value="{{ $category->name }}" class="validate" required>
...
@enderror
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <textarea class="editor" value="{{ $category->description }}" name="description"></textarea>
