    ...
    <div class="container-fluid sb1">
        <div class="row">
            ...
            <div class="col-md-2 col-sm-3 col-xs-6">
                <!-- Dropdown Trigger -->
                <a class='waves-effect dropdown-button top-user-pro' href='#' data-activates='top-menu'><img src="{{ auth()->user()->profile }}" alt="" />{{ auth()->user()->name }} <i class="fa fa-angle-down" aria-hidden="true"></i>
                </a>

                <!-- Dropdown Structure -->
                <ul id='top-menu' class='dropdown-content top-menu-sty'>
                    <li><a href="/admin-panel-setting" class="waves-effect"><i class="fa fa-cogs" aria-hidden="true"></i>Admin Setting</a>
                    </li>
                    <li class="divider"></li>
                    <li>
                        {{-- <a href="#" class="ho-dr-con-last waves-effect"><i class="fa fa-sign-in" aria-hidden="true"></i> Logout
                        </a> --}}
                        <form action="/logout" method="POST">
                            @csrf
                            <li>
                                {{-- <a href="/logout" data-toggle="modal" data-target="#modal2">Logout</a> --}}
                                <button type="submit" class="btn btn-link"><i class="fa fa-sign-in" aria-hidden="true"></i>Logout</button>
                            </li>
                        </form>
                    </li>
                </ul>
