<x-layout>
    <x-slot name="title">Phaung Daw Oo International University</x-slot>
    <!-- SLIDER -->
        ...
        <div class="container">
            <div class="row">
                <div class="wed-hom-ser">
                    <ul>
                        <li>
                            <a href="/awards" class="waves-effect waves-light btn-large wed-pop-ser-btn"><img
                                    src="images/icon/h-ic1.png" alt=""> Academy</a>
                        </li>
                        <li>
                            <a href="/admission" class="waves-effect waves-light btn-large wed-pop-ser-btn"><img
                                    src="images/icon/h-ic2.png" alt=""> Admission</a>
                        </li>
                        <li>
                            <a href="/courses" class="waves-effect waves-light btn-large wed-pop-ser-btn"><img
                                    src="images/icon/h-ic4.png" alt=""> Courses</a>
                        </li>
                        <li>
                            <a href="/seminar" class="waves-effect waves-light btn-large wed-pop-ser-btn"><img
        ...
        <div class="container com-sp pad-bot-70">
            ...
            <div class="row">
                <div class="ed-course">
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <div class="ed-course-in">
                            <a class="course-overlay" href="dashboard">
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <div class="ed-course-in">
                            <a class="course-overlay" href="research">
                ...
                <div class="col-md-4">
                    <div class="bot-gal h-vid ho-event-mob-bot-sp">
                        ...
                        <p>Quisque vitae neque at tellus malesuada convallis. Phasellus in lectus vitae ex euismod
                            interdum non a lorem. Nulla bibendum. Curabitur mi odio, tempus quis risus cursus.</p>
                    </div>
                </div>
                <div class="col-md-4">
